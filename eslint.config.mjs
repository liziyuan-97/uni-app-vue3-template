...
export default [
  ...vuePlugin.configs['flat/recommended'],
  {
    ...
    rules: {
      ...
      'no-useless-escape': 1, // 警告不必要的转义字符
      ...
      semi: 0, // 关闭要求或禁止使用分号
      complexity: ['warn', { max: 20 }], // 强制执行程序中允许的最大圈复杂度
      'keyword-spacing': [
        2,
        {
          before: true,
      ...
      'vue/no-side-effects-in-computed-properties': 1, // 警告代码对计算的属性和函数产生副作用
      'vue/valid-v-on': 1, // 警告校验v-on有效性
      'vue/no-parsing-error': 1, // 警告不允许在＜template＞中出现分析错误
      'vue/require-default-prop': 1, // 警告必须要默认props
      ...
      'vue/multi-word-component-names': 1, // 要求组件名称始终为多词
